<template>
        ...
        <div>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam maiores cumque quia in mollitia accusantium asperiores ex reiciendis numquam eveniet!</p>
          <p class="py-4 text-yellow-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exfdsfsfcepturi, voluptatem sit molestias 
            sed deserunt fugit. Sapiente, tempora. Nesciunt, non architecto.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam maiores cumque quia in mollitia accusantium asperiores ex reiciendis numquam eveniet!</p>
        </div>
        <div class="w-1/3 md:w-full">
        <img class="" src="../assets/technician.svg" alt="SVG mit img Tag laden">
        </div>
      </div>
</template>
