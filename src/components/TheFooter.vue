...
<div class="bg-gray-800 border border-gray-800">
        ...
        <div class="mx-auto sm:max-w-full max-w-fit sm: sm:w-full sm:flex">
            ...
            <div class="w-full sm:w-2/3">
                <div class="flex flex-col text-blue-100">
                    ...
                    <span>Tel.: 0664 123 12 23</span>
                    <span>itn-service@dannemueller.at</span> 
                </div>
            </div>
    ...
    <div class="pt-8 text-center text-gray-300 bg-gray-700">&copy; 2021 - Dannemüller IT & Netzwerkservice</div>
    <div class="pt-2 pb-5 text-center text-gray-300 bg-gray-700">Designed & Built by Thomas Nigg</div>
</div>
</template>
